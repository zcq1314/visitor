...
function imgVer(Config) {
    ...
    var left_Num = -X + 10;
    var html = '<div style="position:relative;padding:16px;border:1px solid #ddd;background:#f2ece1;border-radius:16px;">';
    ...
    html += '</div>';
    html += '<br>';
    html += '<div id="slider-div" style="position:relative;padding-right:20px">';
    ...
    html += '<p style="font-size:12px;color: #486c80;line-height:28px;margin:0;text-align:right;padding-right:14px;">按住左滑块,拖动完成上方拼图</p>';
    html += '</div>';
    ...
    onmouseup = function(e) {
        ...
        if (moveStart == '') {} else {
            if (Max_left > moveEnd_X && moveEnd_X > Min_left) {
                ...
                setTimeout(function() {
                    $('#slider-div').css("visibility","hidden");
